import { Element, Link as LinkSroll } from 'react-scroll';
import Button from '../Button';

const Hero = () => {
    return (
        <section className="relative pb-40 pt-60 max-lg:pb-36 max-md:pb-32 max-md:pt-36">
            <Element name="hero">
                <div className="container">
                    <div className="relative z-2 max-w-512 max-lg:max-w-388">
                        ...
                        <p className="body-1 mb-14 max-w-440 max-md:mb-10">
                            We designed XORA AI Video Editor to be an easy to use, quick
                            to learn, and surprisingly powerful.
                        </p>
                        <LinkSroll to="features" offset={-100} spy smooth>
